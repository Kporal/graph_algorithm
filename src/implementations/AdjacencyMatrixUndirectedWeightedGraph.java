...
public class AdjacencyMatrixUndirectedWeightedGraph extends
		AdjacencyMatrixUndirectedGraph implements IWeightedGraph {
	private final int[][] matrixWeighted;

	public AdjacencyMatrixUndirectedWeightedGraph(int[][] matrixWeighted) {
