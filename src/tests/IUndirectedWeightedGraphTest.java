...
public class IUndirectedWeightedGraphTest {
	...
	private final int[][] matrix = {
			...
			{ 4, Integer.MAX_VALUE, 2, 3 },
			{ 5, 2, Integer.MAX_VALUE, Integer.MAX_VALUE },
	...
	public IUndirectedWeightedGraphTest(Class<IWeightedGraph> cl)
			throws Exception {
		this.implClass = cl;
	...
	public static Collection<Object[]> implList() {
		...
		collection
				.add(new Object[] { AdjacencyListUndirectedWeigthedGraph.class });
		collection
				.add(new Object[] { AdjacencyMatrixUndirectedWeightedGraph.class });
		return collection;
	}
}
